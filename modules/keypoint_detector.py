...
class KPDetector(nn.Module):
    ...
    def gaussian2kp(self, heatmap):
        ...
        grid = make_coordinate_grid(shape[2:], heatmap.type(), heatmap.get_device()).unsqueeze_(0).unsqueeze_(0)
    ...
    def forward(self, x, with_feature=False):
        ...
        # print(feature_map.shape) # b, 32, 16, 64, 64
