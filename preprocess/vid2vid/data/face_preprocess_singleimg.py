...
#         self.A_paths = glob.glob('/data3/shared/MEAD/*/video/front/*/level_3/*.mp4')
        #self.A_paths = (glob.glob('/data3/vox/vox/lrw50_align_ost/img/*.jpg'))
        self.A_paths = (glob.glob('/data3/vox/vox/other_img_align/img/*.jpg'))
...
#         check_path_valid(self.A_paths, self.B_paths)
        #self.output_path = '/data3/vox/vox/lrw50_align_ost/cropped/'
        self.output_path = '/data3/vox/vox/other_img_align/cropped/'
...
#         A, B, I, seq_idx = self.update_frame_idx(self.A_paths, index)
        ...
        #B_path = f'/data3/vox/vox/lrw50_align_ost/lmk/{Asp}.json'
        B_path = f'/data3/vox/vox/other_img_align/lmk/{Asp}.json'
        output = self.output_path + f'{Asp}.jpg'
...
#             return self.frame_idx
    ...
    #         print(B_path)
            ...
            B_size = (A_img.shape[1], A_img.shape[0])
            is_first_frame = True
        else:
        ...
        scale = '256:256'
        Bi = cv2.resize(Bi,dsize=(256,256),fx=1,fy=1,interpolation=cv2.INTER_LINEAR)
        # print(Bi.shape)
        cv2.imwrite(output, Bi)
