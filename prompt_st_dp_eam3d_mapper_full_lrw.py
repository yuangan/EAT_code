...
from frames_dataset_transformer25 import FramesWavsDatasetMEL25VoxBoxQG2ImgPromptNovelStyle2LRW as FramesWavsDatasetMEL25
...
# text = ['She is talking with pouting.']
# text = [    'He is talking with eyes closed.']
text = ['He is talking with a fierce expression.']
# text = ['He is talking with his forehead furrowed and his nostrils flared.']
imgname = "CANCER_00033"
print(text)
...
if __name__ == "__main__":
    ...
    dataset = FramesWavsDatasetMEL25(is_train=(opt.mode == 'train'), imgname=imgname, **config['dataset_params'])
